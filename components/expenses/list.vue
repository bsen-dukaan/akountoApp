                ...
                <template v-else>
                  ...
                  >
                    ...
                    <span
                      ...
                      @click="selectDocument(receipt)"
                      >{{ receipt.file_path.slice(-10) }}</span
                    >
                  </td>
                  ...
                  >
                    {{
                      receipt?.processed_data?.processed_json?.TotalAmount ||
                      "-"
                    }}
                  </td>
                  <td class="whitespace-nowrap px-6 py-4 text-sm text-gray-500">
