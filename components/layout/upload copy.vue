            ...
            <table class="min-w-full divide-y divide-gray-200">
              <thead>
                <tr>
                  ...
                  <th
                    class="bg-gray-50 px-6 py-3 text-right text-sm font-semibold text-gray-900 hidden"
                    scope="col"
                  >
                    Date & Time
                  </th>
              ...
              <tbody class="divide-y divide-gray-200 bg-white">
                ...
                >
                  ...
                  <td
                    class="whitespace-nowrap px-6 py-4 text-right text-sm text-gray-500 hidden"
                  >
                    <span class="truncate text-gray-500">{{
